/* --------------------------------------
Export PDFs from Open Files
by Aaron Troia (@atroia)
Modified Date: 05/05/25

Description: 
Allow PDF Export of both Layout and Story views
in InCopy from open assignment files.
-------------------------------------- */

var scptName = "Export PDFs from Open Files";
